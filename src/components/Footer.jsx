      ...
      <div className="flex flex-wrap justify-around pt-5 m-auto p-3">
        ...
        <div className="flex flex-wrap justify-between items-center gap-10">
          <div className="mr-[5rem]">
            <p className="text-center mt-3 font-semibold"> Follow Us On</p>
            <div className="flex justify-center mt-1">
              <svg
                className=" rounded-full hover:shadow-inner hover:shadow-emerald-600 duration-500"
            ...
            <p className="mt-3"><a href="mailto: techclub@nitdelhi.ac.in" className="hover:text-emerald-300 font-thin"> 📧techclub@nitdelhi.ac.in</a></p>
            <div></div>
          </div>
          <div>
            Quick Links:
        ...
        <div className="w-[25%]">
          <div className="">
            <a href="https://nitdelhi.ac.in/">
              <img
                className=" shadow-md shadow-blue-900 hover:shadow-lg hover:shadow-blue-900 duration-500 h-[6rem]  m-auto rounded-full"
                src={CLogo}
                alt="NITDelhi Logo"
              />
            </a>
