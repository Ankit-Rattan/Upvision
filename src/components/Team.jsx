        ...
        <div className=' mx-[0vh] items-center sm:mx-[10rem] shadow-md my-10 '>
          <div className="">
            ...
            <div className="flex justify-center m-3 mt-[3rem]">
              <Link to='/allteam'>
                <button className="shadow-sm shadow-emerald-200 bg-emerald-500 hover:shadow-lg hover:shadow-emerald-400 duration-500 text-white font-semibold py-2 px-4 rounded">
