...
function EventFull() {
  ...
  const exampleEventsData = [
    ...
    {
      id: 4,
      name: "Envisage 2.0 - Gemini Ideathon",
      date: "August 27, 2024",
      time: "3:00 PM onwards",
      location: "NIT Delhi Auditorium",
      description: "Greetings of the day! Gemini Solutions proudly presents Envisage 2.0, an exciting ideathon designed to ignite your passion for innovation and technical evangelism. This is your chance to bring your creative ideas to life and showcase your entrepreneurial skills in a competitive yet collaborative environment.",
      image: gemini,
    },
  ...
  return (
    <>
      ...
      <section className="event-page">
        ...
        <div className="event-grid flex  justify-evenly w-[80rem]">
          {events.map((event) => (
            <div
              key={event.id}
              className={`event-poster ${activeEvent === event.id ? "active" : ""} flex flex-wrap`}
              onClick={() => toggleEventDetails(event.id)}
            >
              <img
                src={event.image}
                alt={event.name}
                className="event-poster-image w-[1]"
              />
